...
process_name="domain-hr-0.0.1-SNAPSHOT.jar"
process_path="/home/jar/domain-hr"
process_log="domain-hr.log"
project_name="domain-hr"

jvm_opts="-javaagent:/data/gwm/skywalking/agent/skywalking-agent.jar -Dskywalking.agent.service_name=domain-hr"
echo "---开始执行关闭domain-hr进程操作---"
